...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    public static void openCertificateCamera(Activity activity, int type) {
        ...
        //Toast.makeText(activity,"99999",Toast.LENGTH_SHORT).show();
    ...
    private void takePhoto() {
        ...
        //Toast.makeText(CameraActivity.this,"ceshi",Toast.LENGTH_SHORT).show();
            ...
            public void onPictureTaken(final byte[] data, Camera camera) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        //Toast.makeText(CameraActivity.this,"ceshi123",Toast.LENGTH_SHORT).show();
